...
public abstract class AssertUtils {
    ...
    /**
     * 要校验的参数集合，参数集合可以是包含String、List以及自定义对象
     *
     * @param argLists
     */
    public static void hasList(List<?> argLists) {
        for (Object arg : argLists) {
            if (arg instanceof String)
                hasText(String.valueOf(arg));
    ...
    public static void notNumber(String value, String message) {
