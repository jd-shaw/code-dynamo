...
import com.shaw.commons.exception.SystemException;
...
public class RestExceptionHandler {
	...
	public ResResult<Void> handleBusinessException(BaseException ex) {
	...
	public ResResult<Void> handleBusinessException(ConstraintViolationException ex) {
		...
		return Res.response(CommonErrorCode.VALIDATE_PARAMETERS_ERROR, message.toString(),
				MDC.get(CommonCode.TRACE_ID));
	}
