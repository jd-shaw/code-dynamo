...
import com.shaw.cache.configuration.RedisCacheManager;
...
@ConditionalOnProperty(prefix = "dynamo.common.cache", value = "enabled", havingValue = "true", matchIfMissing = true)
public class CachingConfiguration extends CachingConfigurerSupport {
	...
	public CacheManager cacheManager(RedisConnectionFactory redisConnectionFactory) {
		...
		redisCacheManager.setKeysTtl(cachingProperties.getKeysTtl());
