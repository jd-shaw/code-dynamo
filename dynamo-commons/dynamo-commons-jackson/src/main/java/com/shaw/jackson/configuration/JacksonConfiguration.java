package com.shaw.jackson.configuration;
...
import com.shaw.jackson.jdk.Java8TimeModule;
import com.shaw.jackson.jdk.JavaLongTypeModule;
import com.shaw.jackson.util.JacksonUtil;
...
public class JacksonConfiguration {
	...
	public ObjectMapper objectMapper() {
		ObjectMapper objectMapper = new ObjectMapper()
				...
				// 对象属性为空时可以序列化
				.disable(SerializationFeature.FAIL_ON_EMPTY_BEANS).registerModule(new Java8TimeModule())
