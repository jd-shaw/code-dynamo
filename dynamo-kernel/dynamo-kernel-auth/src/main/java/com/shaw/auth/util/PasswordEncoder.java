...
public class PasswordEncoder {
	...
	/**
	 * 对原始密码+用户名合并后
	 * 进行编码。 通常，好的编码算法应用 SHA-1 或更大的哈希值与 8 字节或更大的随机生成的盐值相结合。
	 * @param userName 用户名
	 * @param rawPassword 原始密码
	 * @return 加密后的密码
	 */
	public String encode(String userName, String rawPassword) {
		String str = StringUtils.defaultIfBlank(userName, "") + "#" + rawPassword;
		return SaSecureUtil.md5BySalt(str, authProperties.getSalt());
	}
